...
class Analytics(object):
	...
	def get_sales_transactions_based_on_items(self):
		...
		"""
		.format(date_field=self.date_field, value_field=value_field, value_fields=value_fields, doctype=self.filters.doc_type),
	...
	def get_periodic_data(self):
		...
		for d in self.entries:
			...
			self.entity_periodic_data[d.entity][period] += flt(d.value_field) and flt(d.value_fields)
